...
def topology():
    ...
    r4 = net.addDocker('r4', ip='172.30.4.1/24', dimage="knet/urouter:1.4")
    ...
    h4 = net.addDocker('h4', ip='172.30.4.2/24', defaultRoute='via 172.30.4.1' ,dimage="knet/host-ubuntu:1-2")
    ...
    net.addLink(r1, s5, params1={"ip": "10.30.30.1/24"})
    net.addLink(r4, s5, params1={"ip": "10.30.30.2/24"})
    ...
    s5.cmd("sudo docker cp r1.conf mn.r1:/etc/bird.conf")
    s5.cmd("sudo docker cp r2.conf mn.r2:/etc/bird.conf")
    s5.cmd("sudo docker cp r3.conf mn.r3:/etc/bird.conf")
    s5.cmd("sudo docker cp r4.conf mn.r4:/etc/bird.conf")
